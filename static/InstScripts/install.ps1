...
Write-Host "    3. Set NEXT_PUBLIC_CAPTCHA_URL, CAP_SECRET, and"
Write-Host "       CAPTCHA_VERIFY_URL in project\.env, then run:"
Write-Host "       docker compose up -d --force-recreate frontend backend"
Write-Host "================================================================"
Write-Host ""
